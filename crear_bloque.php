    ...
    if (isset($_POST['crear'])) {
        ...
        if (!empty($_FILES['fondo1']['name'])) {
            ...
            if (!empty($_FILES["fondo1"]["type"])) {
                ...
                if ((($_FILES["fondo1"]["type"] == "image/png") || ($_FILES["fondo1"]["type"] == "image/jpg") || ($_FILES["fondo1"]["type"] == "image/jpeg")) && in_array($file_extension, $valid_extensions)) {
        ...
        if (!empty($_FILES['fondo2']['name'])) {
            ...
            if (!empty($_FILES["fondo2"]["type"])) {
                ...
                $file_extension = end($temporary);
                if ((($_FILES["fondo2"]["type"] == "image/png") || ($_FILES["fondo2"]["type"] == "image/jpg") || ($_FILES["fondo2"]["type"] == "image/jpeg")) && in_array($file_extension, $valid_extensions)) {
        ...
        if (!empty($_FILES["fondo3"]["type"])) {
            ...
            $file_extension = end($temporary);
            if ((($_FILES["fondo3"]["type"] == "image/png") || ($_FILES["fondo3"]["type"] == "image/jpg") || ($_FILES["fondo3"]["type"] == "image/jpeg")) && in_array($file_extension, $valid_extensions)) {
