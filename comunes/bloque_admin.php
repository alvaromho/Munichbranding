        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-lg-6 col-xl-12" data-aos="fade-down" data-aos-delay="500">
                    <form enctype="multipart/form-data" role="form" method="POST"  action="../assets/ajax/crear_bloque.php">
...
<div  class="modal fade" role="dialog" tabindex="-1" id="editarBloque">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-lg-6 col-xl-12" data-aos="fade-down" data-aos-delay="500">
                    <form enctype="multipart/form-data" role="form" method="POST"  action="../assets/ajax/editar_bloque.php">
                        <div class="input-group mb-3 edtFormMarg">
                            <div class="input-group-prepend">
