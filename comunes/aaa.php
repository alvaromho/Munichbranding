            ...
            <div class="projects-list" id="projects-list">
                ...
                <div class="project-item-column type-standard project-type-project  cat-11 cat-4 cat-39 cat-29 cat-20 cat-21 cat-15 cat-10 cat-19 cat-6" data-id="5260" >
                    <div class="project-item-container "  >
                        ...
                        <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[0]["nombre"]).'.php" class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[0]["thumbnail"]).'">
                            <div class="description">
                                <div class="description-container t2">
                                    <h2>
                                        <span class="caption">  '.$lista_proyectos[0]['nombre'].'</span>
                ...
                <div class="project-item-column type-standard project-type-project cat-4 cat-39 cat-12" data-id="5221">
                      <div class="project-item-container">
                          ...
                          <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[1]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[1]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t2">
                                          <h2>
                                            <span class="caption"> '.$lista_proyectos[1]['nombre'].'</span>
                    ...
                    if (isset($lista_proyectos[2])){
                      ...
                      <div class="project-item-container">
                          <span class="menu_order">9</span>
                                ...
                                <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[2]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[2]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t2">
                                          <h2>
...
';
                ...
                <div class="project-item-column type-gallery big-project-item project-type-project cat-4 cat-39 cat-31 cat-8 cat-36" data-id="4151">
                      <div class="project-item-container">
                          ...
                          <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[3]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[3]["thumbnail"]).'">
                                  <div class="description">
...
';
                ...
                <div class="project-item-column type-standard project-type-project cat-4 cat-18 cat-10 cat-32 cat-22" data-id="4108">
                      <div class="project-item-container">
                          ...
                          <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[4]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[4]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t2">
                                          <h2>
...
';
                ...
                <div class="project-item-column type-gallery big-project-item project-type-project cat-4 cat-39 cat-7 cat-40 cat-10 cat-32 cat-22 cat-36" data-id="4031">
                      <div class="project-item-container">
                          ...
                          <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[5]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[5]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t2">
                                          <h2>
...
';
                ...
                <div class="project-item-column type-standard project-type-project cat-28 cat-11 cat-4 cat-21 cat-36 cat-6 " data-id="3908">
                      <div class="project-item-container">
                          ...
                          <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[6]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[6]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t2">
...
';}
                ...
                <div class="project-item-column type-standard project-type-project cat-4 cat-40 cat-22 cat-19" data-id="3651">
                      <div class="project-item-container">
                          ...
                          <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[7]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[7]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t2">
                                          <h2>
...
';}
                ...
                <div class="project-item-column type-gallery big-project-item project-type-project cat-4 cat-31 cat-21 cat-3 cat-36 cat-19" data-id="3496">
                      <div class="project-item-container">
                          ...
                          <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[8]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[8]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t2">
                                          <h2>
...
';}
                ...
                <div class="project-item-column type-standard project-type-project cat-28 cat-11 cat-4 cat-21 cat-36 cat-6" data-id="3236">
                      <div class="project-item-container">
                          ...
                          <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[9]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[9]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t2">
                                          <h2>
...
';}
                ...
                <div class="project-item-column type-standard project-type-project cat-29 cat-17 cat-9 cat-12 cat-10" data-id="3406">
                      <div class="project-item-container">
                          ...
                          <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[10]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[10]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t2">
                                          <h2>
...
';}
                    ...
                    <div class="project-item-column type-gallery big-project-item project-type-project cat-4 cat-31 cat-17 cat-9 cat-8 cat-3 cat-10 cat-22 cat-36 cat-6" data-id="2735">
                      <div class="project-item-container">
                          ...
                          <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[11]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[11]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t2">
                                          <h2>
...
';
                ...
                <div class="project-item-column type-standard project-type-project cat-31 cat-17 cat-25 cat-21 cat-19" data-id="2696">
                      <div class="project-item-container">
                          ...
                          <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[12]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[12]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t2">
                                          <h2>
                ...
                <div class="project-item-column type-standard project-type-project cat-4 cat-31 cat-8 cat-36 cat-34" data-id="2607">
                      <div class="project-item-container">
                          <span class="menu_order">91</span>
                           <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[13]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[13]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t3">
                                          <h2>
                    ...
                    if (isset($lista_proyectos[14])){
                      ...
                      <div class="project-item-container">
                          ...
                          <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[14]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[14]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t2">
                                          <h2>
                ...
                <div class="project-item-column type-standard project-type-project cat-31 cat-17 cat-25 cat-21 cat-19" data-id="2696">
                      <div class="project-item-container">
                          <span class="menu_order">45</span>
                          <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[15]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[15]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t2">
                                          <h2>
                ...
                <div class="project-item-column type-standard project-type-project cat-4 cat-31 cat-8 cat-36 cat-34" data-id="2607">
                      <div class="project-item-container">
                          <span class="menu_order">91</span>
                           <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[16]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[16]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t3">
                                          <h2>
                      ...
                      <div class="project-item-container">
                          ...
                          <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[17]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[17]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t2">
                                          <h2>
                ...
                <div class="project-item-column type-standard project-type-project cat-11 cat-4 cat-39 cat-29 cat-20 cat-21 cat-15 cat-10 cat-19 cat-6" data-id="5260" >
                    <div class="project-item-container "  >
                        <span class="menu_order">3</span>
                        <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[18]["nombre"]).'.php" class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[18]["thumbnail"]).'">
                            <div class="description">
                                <div class="description-container t2">
                                    <h2>
                ...
                <div class="project-item-column type-standard project-type-project cat-4 cat-39 cat-12" data-id="5221">
                      <div class="project-item-container">
                          <span class="menu_order">4</span>
                          <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[19]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[19]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t2">
                                          <h2>
...
';
                      ...
                      <div class="project-item-container">
                          <span class="menu_order">9</span>
                                ...
                                <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[20]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[20]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t2">
                                          <h2>
...
';
                ...
                <div class="project-item-column type-gallery big-project-item project-type-project cat-4 cat-39 cat-31 cat-8 cat-36" data-id="4151">
                      <div class="project-item-container">
                          ...
                          <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[21]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[21]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t3">
                                          <h2>
...
';
                ...
                <div class="project-item-column type-standard project-type-project cat-4 cat-18 cat-10 cat-32 cat-22" data-id="4108">
                      <div class="project-item-container">
                          <span class="menu_order">17</span>
                          <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[22]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[22]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t2">
                                          <h2>
...
';
                ...
                <div class="project-item-column type-gallery big-project-item project-type-project cat-4 cat-39 cat-7 cat-40 cat-10 cat-32 cat-22 cat-36" data-id="4031">
                      <div class="project-item-container">
                          <span class="menu_order">19</span>
                          <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[23]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[23]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t2">
                                          <h2>
...
';
                ...
                <div class="project-item-column type-standard project-type " data-id="3908">
                      <div class="project-item-container">
                          ...
                          <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[24]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[24]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t2">
...
';}
                ...
                <div class="project-item-column type-standard project-type-project cat-4 cat-40 cat-22 cat-19" data-id="3651">
                      <div class="project-item-container">
                          ...
                          <a href="http://munichbranding.cl/'.str_replace(" ","_", $lista_proyectos[25]["nombre"]).'.php"  class="project-item-link project-item bg-image" target="_self" data-image="img/'.str_replace(" ", "_",$lista_proyectos[25]["thumbnail"]).'">
                                  <div class="description">
                                      <div class="description-container t2">
                                          <h2>
